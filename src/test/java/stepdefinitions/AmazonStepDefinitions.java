...
public class AmazonStepDefinitions {
    ...
    public void nutella_icin_arama_yapar() {
        this.amazonPage.aramaKutusu.sendKeys(new CharSequence[]{"Nutella" + Keys.ENTER});
    }

    @Then("Arama sonuclarinin Nutella icerdigini test eder")
    public void arama_sonuclarinin_nutella_icerdigini_test_eder() {
        String actualAramaSonucu = this.amazonPage.aramaSonucuElementi.getText();
    ...
    public void java_icin_arama_yapar() {
        this.amazonPage.aramaKutusu.sendKeys(new CharSequence[]{"Java" + Keys.ENTER});
    }
    ...
    public void samsungIcinAramaYapar() {
        this.amazonPage.aramaKutusu.sendKeys(new CharSequence[]{"Samsung" + Keys.ENTER});
    }
    ...
    public void icinAramaYapar(String aranacakKelime) {
        ...
        this.amazonPage.aramaKutusu.sendKeys(new CharSequence[]{aranacakKelime + Keys.ENTER});
    }
    ...
    public void saniyeBekler(int beklenecekSaniye) {
        ...
        try {
            Thread.sleep((long)(beklenecekSaniye * 1000));
